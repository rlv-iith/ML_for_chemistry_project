...
```
*All plots are automatically generated by `02_train_model.py` and saved to the `results/` folder.*

### 1. Capacity Fade Curves (Figure 1a Replica)
![Capacity Curves](results/Nature_Fig1a_Replica.png)
**What this shows:** The discharge capacity of 124 batteries over time.
- **Red lines:** Batteries that died quickly (<500 cycles).
...
- **Dashed Red Line:** Perfect accuracy.
- **The Story:** Most points cluster tightly around the red line. The **RMSE of ~275 cycles** means the model is accurate enough to classify batteries as "High Quality" or "Low Quality" weeks before they actually fail.
---
📚 References
